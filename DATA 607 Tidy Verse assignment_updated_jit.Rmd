...
author: "Yohannes Deboch, modificaition by Jithendra Seneviratne"
...
```{r}
### To demonstrate the functionality of ggplot, I've taken the above example and looked at the distribution of age by gender in this study where 1= 'male and 0 = 'female'
```
